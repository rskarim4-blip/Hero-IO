        ...
        <div>
            <div className="navbar bg-base-100 px-10 ">
                ...
                <div className="navbar-end ">
                    ...
                    <Link to={'https://github.com/rskarim4-blip/Hero-IO.git'} target="true" className="btn bg-linear-to-br from-[#632EE3] to-[#9F62F2] text-white"><Github strokeWidth={1.7} /> Contribute</Link>
                </div>
            </div>
        </div>
    );
